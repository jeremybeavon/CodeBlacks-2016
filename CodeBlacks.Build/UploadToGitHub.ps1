...
$refTask = $client.Git.Reference.Get("jeremybeavon", "CodeBlacks-Release", "heads/master")
$treeTask = $client.Git.Tree.Get("jeremybeavon", "CodeBlacks-Release", $refTask.Result.Object.Sha)
...
$createReleasePackageBlob = $client.Git.Blob.Create("jeremybeavon", "CodeBlacks-Release", $newReleasePackageBlob)
...
$createPublishPackageBlob = $client.Git.Blob.Create("jeremybeavon", "CodeBlacks-Release", $newPublishPackageBlob)
...
$createTreeTask = $client.Git.Tree.Create("jeremybeavon", "CodeBlacks-Release", $newTree)
...
$createCommitTask = $client.Git.Commit.Create("jeremybeavon", "CodeBlacks-Release", $newCommit)
$referenceUpdate = New-Object Octokit.ReferenceUpdate -ArgumentList $createCommitTask.Result.Sha
$client.Git.Reference.Update("jeremybeavon", "CodeBlacks-Release", "heads/master", $referenceUpdate)